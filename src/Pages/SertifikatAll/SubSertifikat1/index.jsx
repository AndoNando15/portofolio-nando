...
import sertifikatLomba from '/Sertifikat/sertifikat-lomba_code_championship_juara_3.png'; // Example path if it's inside src/assets folder
    ...
    <div className="flex flex-col min-h-screen mt-15 bg-[#F0F8FF]">
      ...
      <section className="py-10 px-4 md:px-20">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Sertifikat Details */}
          <div className="text-center mb-6">
            <h2 className="text-3xl font-semibold text-[#4682B4] mb-2">CODE CHAMPIONSHIP : Musywil Jawa Timur 2023</h2>
            <div className="flex justify-center gap-4 mb-6">
              <span className="bg-[#356699] text-white text-xs px-4 py-2 rounded-full">Juni 3</span>
              <span className="bg-[#356699] text-white text-xs px-4 py-2 rounded-full">22 Desember 2023</span>
            </div>
          </div>
          {/* Sertifikat Image */}

          <img src={sertifikatLomba} alt="Sertifikat 1" className="w-full h-full object-cover rounded-lg mb-4 shadow-sm" />
