...
const SubProyek9 = () => {
  ...
  const cardDescriptions = [
    { title: 'Halaman Login', image: '/images/Proyek/app-wallet/halaman-login.png' },
    { title: 'Halaman Dashboard', image: '/images/Proyek/app-wallet/halaman-dashboard.png' },
    { title: 'Halaman Dataset', image: '/images/Proyek/app-wallet/halaman-dataset.png' },
    { title: 'Halaman Cluster', image: '/images/Proyek/app-wallet/halaman-cluster.png' },
    { title: 'Halaman Proses', image: '/images/Proyek/app-wallet/halaman-proses.png' },
  ];
    ...
    <div className="flex flex-col min-h-screen mt-15 bg-[#F0F8FF]">
      ...
      <section className="py-10 px-4 md:px-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            <h2 className="text-3xl font-semibold text-[#4682B4] mb-2">APP Wallet</h2>
