...
const SubProyek12 = () => {
  ...
  const cardDescriptions = [
    { title: 'Halaman Dashboard', image: '/images/Proyek/hybrid-montecarlo/halaman-dashboard.png' },
    { title: 'Halaman Dataset', image: '/images/Proyek/hybrid-montecarlo/halaman-dataset.png' },
    { title: 'Halaman Monte Carlo', image: '/images/Proyek/hybrid-montecarlo/halaman-montecarlo.png' },
    { title: 'Halaman Smothing', image: '/images/Proyek/hybrid-montecarlo/halaman-smothing.png' },
    { title: 'Halaman Hasil Akhir', image: '/images/Proyek/hybrid-montecarlo/halaman-hasilakhir.png' },
  ];
    ...
    <div className="flex flex-col min-h-screen mt-15 bg-[#F0F8FF]">
      ...
      <section className="py-10 px-4 md:px-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            <h2 className="text-3xl font-semibold text-[#4682B4] mb-2">Hybrid Monte Carlo</h2>
            <div className="flex justify-center gap-4 mb-6 flex-wrap">
              ...
              <span className="bg-[#356699] text-white text-xs px-4 py-2 rounded-full">Monte Carlo</span>
              <span className="bg-[#356699] text-white text-xs px-4 py-2 rounded-full">Smothing</span>
              <span className="bg-[#356699] text-white text-xs px-4 py-2 rounded-full">Analisis</span>
            </div>
          </div>
